...
var Phidget = function() {
  ...
  this.ready = false;
  this.reconnect = true;
  this.type = "PhidgetInterfaceKit"; // default
...
Phidget.prototype.connect = function(options) {
  ...
  self._client = net.createConnection(self.port, self.host, function(){
    ...
    //self.connectWaitTimer = setTimeout(self.checkReady, self._readyWaitTimeout, next, self);
    self.connectWaitTimer = setTimeout(self.checkReady, self._readyWaitTimeout, self);
...
Phidget.prototype.checkReady = function(self){
...
Phidget.prototype.handleConnectionEnd = function(self) {
