...
/**
 * The `PhidgetBridge` class allows you to receive data from PhidgetBridge modules. Beware
...
///**
// * The PhidgetRFID class allows you to control a PhidgetRFID board.
// *
// * This object extends the `Phidget` object which itself extends Node.js'
// * [`events.EventEmitter` object](https://nodejs.org/api/events.html#events_class_events_eventemitter).
// * See that object's documentation for inherited methods.
...
//   *
//   * Here is how to retrieve an outputs value or the total number of outputs:
//   *
...
//   * the reader to work properly. Setting this property to `true` activates the antenna
