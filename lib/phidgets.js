...
var PhidgetInterfaceKit = function() {
   ...
   * the sensor number. For example: `PhidgetInterfaceKit.rawSensors[5]`.
   *
   * @property rawSensors
   * @type {Object}
   */
...
/**
 * Sets the the update interval of a sensor. The update interval is the number of
...
PhidgetInterfaceKit.prototype._parsePhidgetSpecificData = function (data) {
  ...
  if (data.keyword === "Input") {
     ...
     */
    self.rawSensors[data.index] = parseInt(data.value);
    self.emit(
      "sensor",
      self,
